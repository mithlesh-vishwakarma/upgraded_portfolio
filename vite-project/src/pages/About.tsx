...
technologies: ["MS Excel", "Tally ERP", "Google Sheets", "Email Communication", "CRM Tools","Account Handling", "Billing & Invoicing", "Data Entry & Analysis", "Financial Reporting"]
  ...
  const skillsData = {
    ...
    backend: [
      ...
      // { name: "Express.js", percentage: 40, icon: Server },
      // { name: "MongoDB", percentage: 45, icon: Database },
      { name: "MySQL", percentage: 70, icon: Database },
      // { name: "REST APIs", percentage: 35, icon: Globe }
    ],
    tools: [
  ...
  const SkillBar = ({ skill, delay = 0 }) => {
    ...
    return (
      <div 
        className="mb-6 transform transition-all duration-500 hover:scale-105"
      ...
      >
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-yellow-400 font-semibold">{skill.percentage}%</span>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-16"> {/* Matches ContactPage padding */}
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all duration-300 transform ${
                      activeTab === id
                        ...
                        : 'text-gray-300 hover:text-yellow-400 hover:bg-white/5 hover:scale-102'
                    }`}
                  >
